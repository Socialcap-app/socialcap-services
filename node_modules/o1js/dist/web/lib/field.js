...
export { Field };
// internal API
export { FieldType, FieldVar, FieldConst, isField, withMessage, readVarMessage, toConstantField, toFp, };
...
class Field {
    ...
    equals(y) {
        ...
        let xMinusY = Snarky.existsVar(() => FieldConst.fromBigint(Fp.sub(this.toBigInt(), toFp(y))));
