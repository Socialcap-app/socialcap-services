...
function createField(p3, t, twoadicRoot) {
  return {
    ...
    rot(x, bits2, direction = "left") {
      let bitArray = x.toString(2).split("").reverse().map(Number);
      let binary = bitArray.length >= 64 ? bitArray.splice(0, 64) : [...bitArray, ...Array(64 - bitArray.length).fill(0)];
...
function fieldsToRustFlat([, ...fields]) {
  ...
  for (let i2 = 0, offset = 0; i2 < n; i2++, offset += fieldSizeBytes) {
    let fieldBytes = fieldToRust(fields[i2]);
...
var proofEvaluationsToRust = mapProofEvaluations(fieldToRust);
var proofEvaluationsFromRust = mapProofEvaluations(fieldFromRust);
var pointEvalsOptionToRust = mapPointEvalsOption(fieldToRust);
...
function verifierIndexConversionPerField(wasm2, core, { Domain, VerificationEvals, Shifts, VerifierIndex, LookupVerifierIndex, LookupSelector }) {
  ...
  function lookupSelectorsToRust([, lookup, xor3, range_check, ffmul]) {
    return new LookupSelector(MlOption.mapFrom(xor3, core.polyCommToRust), MlOption.mapFrom(lookup, core.polyCommToRust), MlOption.mapFrom(range_check, core.polyCommToRust), MlOption.mapFrom(ffmul, core.polyCommToRust));
  }
  function lookupSelectorsFromRust(selector) {
    let lookup = MlOption.mapTo(selector.lookup, core.polyCommFromRust);
    let xor3 = MlOption.mapTo(selector.xor, core.polyCommFromRust);
    ...
    selector.free();
    return [0, lookup, xor3, range_check, ffmul];
  }
  function lookupInfoToRust([, maxPerRow, maxJointSize, features]) {
    let [, patterns, joint_lookup_used, uses_runtime_tables] = features;
    let [, xor3, lookup, range_check, foreign_field_mul] = patterns;
    let wasmPatterns = new wasm2.LookupPatterns(MlBool.from(xor3), MlBool.from(lookup), MlBool.from(range_check), MlBool.from(foreign_field_mul));
    ...
    lagrangeCommitment(srs2, domainSize, i2) {
      ...
      if (commitment === void 0) {
        if (cache === void 0) {
          ...
          assert(c !== void 0, "commitment exists after setting");
          commitment = c;
        }
      }
...
CJS:
  if (typeof require !== "undefined") {
    snarky = require("./bindings/compiled/_node_bindings/snarky_js_node.bc.cjs");
  }
...
var Bool3 = class _Bool {
  constructor(x) {
    if ((0, import_tslib.__classPrivateFieldGet)(_Bool, _a, "m", _Bool_isBool).call(_Bool, x)) {
      this.value = x.value;
      return;
    }
    if (Array.isArray(x)) {
  ...
  and(y) {
    ...
    return new _Bool(Snarky.bool.and(this.value, (0, import_tslib.__classPrivateFieldGet)(_Bool, _a, "m", _Bool_toVar).call(_Bool, y)));
  }
  /**
  ...
  or(y) {
    ...
    return new _Bool(Snarky.bool.or(this.value, (0, import_tslib.__classPrivateFieldGet)(_Bool, _a, "m", _Bool_toVar).call(_Bool, y)));
  }
  /**
  ...
  assertEquals(y, message) {
    try {
      ...
      Snarky.bool.assertEqual(this.value, (0, import_tslib.__classPrivateFieldGet)(_Bool, _a, "m", _Bool_toVar).call(_Bool, y));
    } catch (err) {
  ...
  equals(y) {
    ...
    return new _Bool(Snarky.bool.equals(this.value, (0, import_tslib.__classPrivateFieldGet)(_Bool, _a, "m", _Bool_toVar).call(_Bool, y)));
  }
  /**
  ...
  static toField(x) {
    return new Field3((0, import_tslib.__classPrivateFieldGet)(_Bool, _a, "m", _Bool_toVar).call(_Bool, x));
  }
  /**
   * Boolean negation.
   */
...
var Field3 = class _Field {
  ...
  constructor(x) {
    ...
    if ((0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_isField).call(_Field, x)) {
      this.value = x.value;
      return;
    }
    if (Array.isArray(x)) {
  ...
  assertEquals(y, message) {
    try {
      ...
      Snarky.field.assertEqual(this.value, (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_toVar).call(_Field, y));
    } catch (err) {
  ...
  add(y) {
    ...
    let z = Snarky.field.add(this.value, (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_toVar).call(_Field, y));
    return new _Field(z);
  }
  /**
  ...
  mul(y) {
    ...
    if (isConstant2(y)) {
      let z2 = Snarky.field.scale((0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_toConst).call(_Field, y), this.value);
  ...
  lessThan(y) {
    ...
    return (0, import_tslib2.__classPrivateFieldGet)(this, _Field_instances, "m", _Field_compare).call(this, (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_toVar).call(_Field, y)).less;
  }
  /**
  ...
  lessThanOrEqual(y) {
    ...
    return (0, import_tslib2.__classPrivateFieldGet)(this, _Field_instances, "m", _Field_compare).call(this, (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_toVar).call(_Field, y)).lessOrEqual;
  }
  /**
  ...
  assertLessThan(y, message) {
    try {
      ...
      let { less } = (0, import_tslib2.__classPrivateFieldGet)(this, _Field_instances, "m", _Field_compare).call(this, (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_toVar).call(_Field, y));
      less.assertTrue();
    } catch (err) {
      throw withMessage2(err, message);
    }
  ...
  assertLessThanOrEqual(y, message) {
    try {
      ...
      let { lessOrEqual } = (0, import_tslib2.__classPrivateFieldGet)(this, _Field_instances, "m", _Field_compare).call(this, (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_toVar).call(_Field, y));
  ...
  toBits(length) {
    if (length !== void 0)
      (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_checkBitLength).call(_Field, "Field.toBits()", length);
    if (this.isConstant()) {
  ...
  static fromBits(bits2) {
    ...
    (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_checkBitLength).call(_Field, "Field.fromBits()", length);
  ...
  rangeCheckHelper(length) {
    (0, import_tslib2.__classPrivateFieldGet)(_Field, _a2, "m", _Field_checkBitLength).call(_Field, "Field.rangeCheckHelper()", length);
    if (length % 16 !== 0)
...
function provable2(typeObj, options) {
  ...
  function toInput(typeObj2, obj, isToplevel = false) {
    ...
    return (isToplevel ? objectKeys : Object.keys(typeObj2)).map((k) => toInput(typeObj2[k], obj[k])).reduce(HashInput.append, HashInput.empty);
  }
  function toJSON(typeObj2, obj, isToplevel = false) {
    if (typeObj2 === BigInt)
      return obj.toString();
...
function provablePure(typeObj) {
  return provable2(typeObj, { isPure: true });
}
  ...
  add(g) {
    ...
    if ((0, import_tslib4.__classPrivateFieldGet)(this, _Group_instances, "m", _Group_isConstant).call(this) && (0, import_tslib4.__classPrivateFieldGet)(g, _Group_instances, "m", _Group_isConstant).call(g)) {
      if (this.isZero().toBoolean()) {
        ...
        return (0, import_tslib4.__classPrivateFieldGet)(_Group, _a3, "m", _Group_fromProjective).call(_Group, g_proj);
      }
    } else {
      ...
      let [, x, y] = Snarky.gates.ecAdd((0, import_tslib4.__classPrivateFieldGet)(_b = _Group.from(x1.seal(), y1.seal()), _Group_instances, "m", _Group_toTuple).call(_b), (0, import_tslib4.__classPrivateFieldGet)(_c = _Group.from(x2.seal(), y2.seal()), _Group_instances, "m", _Group_toTuple).call(_c), (0, import_tslib4.__classPrivateFieldGet)(_d = _Group.from(x3, y3), _Group_instances, "m", _Group_toTuple).call(_d), inf.toField().value, same_x.value, s.value, inf_z.value, x21_inv.value);
...
var UInt642 = class _UInt64 extends CircuitValue {
  ...
  toUInt32Clamped() {
    let max = (1n << 32n) - 1n;
    return Provable.if(this.greaterThan(_UInt64.from(max)), UInt322.from(max), new UInt322(this.value));
  }
  static check(x) {
  ...
  divMod(y) {
    ...
    q3.rangeCheckHelper(_UInt64.NUM_BITS).assertEquals(q3);
    let r = x.sub(q3.mul(y_)).seal();
    r.rangeCheckHelper(_UInt64.NUM_BITS).assertEquals(r);
  ...
  mul(y) {
    ...
    z.rangeCheckHelper(_UInt64.NUM_BITS).assertEquals(z);
  ...
  lte(y) {
    if (this.value.isConstant() && y.value.isConstant()) {
      ...
      let xMinusYFits = xMinusY.rangeCheckHelper(_UInt64.NUM_BITS).equals(xMinusY);
      let yMinusXFits = yMinusX.rangeCheckHelper(_UInt64.NUM_BITS).equals(yMinusX);
  ...
  assertLessThanOrEqual(y, message) {
    ...
    yMinusX.rangeCheckHelper(_UInt64.NUM_BITS).assertEquals(yMinusX, message);
  }
  /**
...
var UInt322 = class _UInt32 extends CircuitValue {
  ...
  divMod(y) {
    ...
    y_ = y_.seal();
    let q3 = Provable.witness(Field4, () => new Field4(x.toBigInt() / y_.toBigInt()));
    q3.rangeCheckHelper(_UInt32.NUM_BITS).assertEquals(q3);
    let r = x.sub(q3.mul(y_)).seal();
    r.rangeCheckHelper(_UInt32.NUM_BITS).assertEquals(r);
  ...
  mul(y) {
    ...
    z.rangeCheckHelper(_UInt32.NUM_BITS).assertEquals(z);
  ...
  lte(y) {
    if (this.value.isConstant() && y.value.isConstant()) {
      ...
      let xMinusY = this.value.sub(y.value).seal();
      let yMinusX = xMinusY.neg();
      let xMinusYFits = xMinusY.rangeCheckHelper(_UInt32.NUM_BITS).equals(xMinusY);
      let yMinusXFits = yMinusX.rangeCheckHelper(_UInt32.NUM_BITS).equals(yMinusX);
      xMinusYFits.or(yMinusXFits).assertEquals(true);
      return yMinusXFits;
    }
  }
  ...
  assertLessThanOrEqual(y, message) {
    ...
    let yMinusX = y.value.sub(this.value).seal();
    yMinusX.rangeCheckHelper(_UInt32.NUM_BITS).assertEquals(yMinusX, message);
  }
  /**
   * @deprecated Use {@link lessThan} instead.
   *
...
var Int64 = class _Int64 extends CircuitValue {
  ...
  static fromFieldUnchecked(x) {
    ...
    return new _Int64(new UInt642(magnitude), sign2);
  }
  ...
  div(y) {
    ...
    return new _Int64(quotient, sign2);
  }
  /**
   * Integer remainder.
   *
...
function zero(a2, b2, c) {
  Snarky.gates.zero(a2.value, b2.value, c.value);
}
...
function exists(n, compute) {
  ...
  let vars = MlArray.mapFrom(varsMl, (v) => new Field3(v));
  return TupleN.fromArray(n, vars);
}
function assert2(stmt, message) {
  if (!stmt) {
...
function witnessSlice(f, start, length) {
  ...
  return Provable.witness(Field3, () => {
    let n = f.toBigInt();
    return new Field3(n >> BigInt(start) & (1n << BigInt(length)) - 1n);
  });
}
function witnessNextValue(current) {
  return Provable.witness(Field3, () => new Field3(current.toBigInt() >> 16n));
}
...
function multiRangeCheck([x, y, z]) {
  ...
  rangeCheck1Helper({ x64, x76, y64, y76, z, yz: new Field3(0) });
}
function compactMultiRangeCheck(xy, z) {
  if (xy.isConstant() && z.isConstant()) {
    if (xy.toBigInt() >> twoL || z.toBigInt() >> L) {
      throw Error(`Expected fields to fit in ${twoL} and ${L} bits respectively, got ${xy}, ${z}`);
    }
...
function rangeCheck0Helper(x, isCompact = false) {
  ...
  rangeCheck0(x, [x76, x64, x52, x40, x28, x16], [x14, x12, x10, x8, x6, x4, x2, x0], isCompact);
  return [x64, x76];
}
function rangeCheck1Helper(inputs) {
  ...
  rangeCheck1(z, yz, [z86, z74, z62, z50, z38, z36, z34, z32, z30, z28, z26, z24, z22], [z20, z18, z16, x76, x64, y76, y64, z14, z12, z10, z8, z6, z4, z2, z0]);
}

// dist/node/lib/gadgets/bitwise.js
function not(a2, length, checked = false) {
  assert2(length > 0, `Input length needs to be positive values.`);
  assert2(length < Field3.sizeInBits(), `Length ${length} exceeds maximum of ${Field3.sizeInBits()} bits.`);
  let padLength = Math.ceil(length / 16) * 16;
  if (a2.isConstant()) {
    let max = 1n << BigInt(padLength);
    assert2(a2.toBigInt() < max, `${a2.toBigInt()} does not fit into ${padLength} bits`);
    return new Field3(Field.not(a2.toBigInt(), length));
  }
  let allOnesF = new Field3(2n ** BigInt(length) - 1n);
  let allOnes = Provable.witness(Field3, () => {
    return allOnesF;
  });
  ...
  if (checked) {
    ...
    return allOnes.sub(a2);
  }
}
function xor2(a2, b2, length) {
  assert2(length > 0, `Input lengths need to be positive values.`);
  assert2(length <= 254, `Length ${length} exceeds maximum of 254 bits.`);
  let padLength = Math.ceil(length / 16) * 16;
  if (a2.isConstant() && b2.isConstant()) {
    let max = 1n << BigInt(padLength);
    assert2(a2.toBigInt() < max, `${a2.toBigInt()} does not fit into ${padLength} bits`);
    assert2(b2.toBigInt() < max, `${b2.toBigInt()} does not fit into ${padLength} bits`);
...
function buildXor(a2, b2, expectedOutput, padLength) {
  while (padLength !== 0) {
    let in1_0 = witnessSlice(a2, 0, 4);
    let in1_1 = witnessSlice(a2, 4, 4);
    let in1_2 = witnessSlice(a2, 8, 4);
    let in1_3 = witnessSlice(a2, 12, 4);
    let in2_0 = witnessSlice(b2, 0, 4);
    let in2_1 = witnessSlice(b2, 4, 4);
    let in2_2 = witnessSlice(b2, 8, 4);
    let in2_3 = witnessSlice(b2, 12, 4);
    ...
    xor(a2, b2, expectedOutput, in1_0, in1_1, in1_2, in1_3, in2_0, in2_1, in2_2, in2_3, out0, out1, out2, out3);
    a2 = witnessNextValue(a2);
    b2 = witnessNextValue(b2);
    expectedOutput = witnessNextValue(expectedOutput);
    padLength = padLength - 16;
  }
  zero(a2, b2, expectedOutput);
  let zero2 = new Field3(0);
  zero2.assertEquals(a2);
  zero2.assertEquals(b2);
  zero2.assertEquals(expectedOutput);
}
...
function rotate2(field, bits2, direction = "left") {
  assert2(bits2 >= 0 && bits2 <= MAX_BITS, `rotation: expected bits to be between 0 and 64, got ${bits2}`);
  if (field.isConstant()) {
    assert2(field.toBigInt() < 2n ** BigInt(MAX_BITS), `rotation: expected field to be at most 64 bits, got ${field.toBigInt()}`);
    return new Field3(Field.rot(field.toBigInt(), bits2, direction));
  }
  const [rotated] = rot(field, bits2, direction);
  return rotated;
}
function rot(field, bits2, direction = "left") {
...
function rightShift(field, bits2) {
  assert2(bits2 >= 0 && bits2 <= MAX_BITS, `rightShift: expected bits to be between 0 and 64, got ${bits2}`);
  if (field.isConstant()) {
    assert2(field.toBigInt() < 2n ** BigInt(MAX_BITS), `rightShift: expected field to be at most 64 bits, got ${field.toBigInt()}`);
    return new Field3(Field.rightShift(field.toBigInt(), bits2));
  }
  const [, excess] = rot(field, bits2, "right");
  return excess;
}
function leftShift(field, bits2) {
  assert2(bits2 >= 0 && bits2 <= MAX_BITS, `rightShift: expected bits to be between 0 and 64, got ${bits2}`);
  if (field.isConstant()) {
    assert2(field.toBigInt() < 2n ** BigInt(MAX_BITS), `rightShift: expected field to be at most 64 bits, got ${field.toBigInt()}`);
    return new Field3(Field.leftShift(field.toBigInt(), bits2));
  }
  const [, , shifted] = rot(field, bits2, "left");
  return shifted;
}
...
var Gadgets = {
   ...
   * ```
   */
  rotate(field, bits2, direction = "left") {
    return rotate2(field, bits2, direction);
  },
  /**
   ...
   * ```
   */
  leftShift(field, bits2) {
    return leftShift(field, bits2);
  },
  /**
   ...
   * ```
   */
  rightShift(field, bits2) {
    return rightShift(field, bits2);
  },
  /**
...
function ProvableFromLayout(TypeMap3, customTypes3) {
  ...
  function emptyValue4(typeData) {
    let zero2 = TypeMap3.Field.fromJSON("0");
    return layoutFold({
      map(type) {
        if (type.emptyValue)
          return type.emptyValue();
        return type.fromFields(Array(type.sizeInFields()).fill(zero2), type.toAuxiliary());
      },
      reduceArray(array) {
        return array;
      },
...
function parseHeader(programName, methods, header) {
  let hash2 = Pickles.util.fromMlString(header[1][2][8]);
  switch (header[0]) {
    ...
    case KeyType.StepVerificationKey: {
      ...
      let uniqueId = sanitize(`${kind}-${programName}-${methodIndex}-${methodName}-${hash2}`);
      return {
    ...
    case KeyType.WrapVerificationKey: {
      ...
      let uniqueId = sanitize(`${kind}-${programName}-${hash2}`);
      return {
        version: cacheHeaderVersion,
        uniqueId,
        kind,
...
function ZkProgram(config) {
  ...
  let compileOutput;
  async function compile({ cache: cache2 = Cache.FileSystemDefault } = {}) {
...
async function compileProgram({ publicInputType, publicOutputType, methodIntfs, methods, gates, proofSystemTag, cache: cache2, overrideWrapDomain }) {
...
function synthesizeMethodArguments({ allArgs, proofArgs, witnessArgs }, asVariables = false) {
  let args = [];
  let empty2 = asVariables ? emptyWitness : emptyValue3;
  for (let arg of allArgs) {
    if (arg.type === "witness") {
      args.push(empty2(witnessArgs[arg.index]));
    } else if (arg.type === "proof") {
      let Proof3 = proofArgs[arg.index];
      let type = getStatementType(Proof3);
      let publicInput = empty2(type.input);
      let publicOutput = empty2(type.output);
...
var SmartContract = class {
   ...
   */
  static async compile({ cache: cache2 = Cache.FileSystemDefault } = {}) {
    ...
    let { verificationKey: verificationKey_, provers, verify: verify3 } = await compileProgram({
...
Use the optional \`maxTransactionsWithActions\` argument to increase this number.`);
    ...
    forEach(actionLists, callback, fromActionState, config) {
      const stateType = provable2(null);
...
var AccountId = provable2({ tokenOwner: PublicKey2, parentTokenId: Field4 });
var TokenId4 = {
...
var AccountUpdate3 = class _AccountUpdate {
  ...
  static dummy() {
    return new _AccountUpdate(Body.dummy());
  }
  isDummy() {
  ...
  static witness(type, compute, { skipCheck = false } = {}) {
    let accountUpdateType = skipCheck ? { ...provable2(_AccountUpdate), check() {
    } } : _AccountUpdate;
  ...
  static witnessChildren(accountUpdate, childLayout, options) {
    ...
    for (let i2 = 0; i2 < n; i2++) {
      accountUpdate.children.accountUpdates[i2] = _AccountUpdate.witnessTree(provable2(null), childArray[i2], () => ({
...
function Network2(input) {
  ...
  if (input && typeof input === "string") {
    ...
    if (input.lightnetAccountManager !== void 0 && typeof input.lightnetAccountManager === "string") {
