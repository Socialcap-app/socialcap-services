...
declare const VestaBindings: {
    caml_vesta_sub: (g: GroupProjective, h: GroupProjective) => {
        x: bigint;
        y: bigint;
        z: bigint;
    };
    caml_vesta_add: (g: GroupProjective, h: GroupProjective) => {
        x: bigint;
        y: bigint;
        z: bigint;
    };
...
declare const PallasBindings: {
    caml_pallas_sub: (g: GroupProjective, h: GroupProjective) => {
        x: bigint;
        y: bigint;
        z: bigint;
    };
    caml_pallas_add: (g: GroupProjective, h: GroupProjective) => {
        x: bigint;
        y: bigint;
        z: bigint;
    };
