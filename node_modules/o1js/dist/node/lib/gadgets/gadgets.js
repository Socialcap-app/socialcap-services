 ...
 */
import { compactMultiRangeCheck, multiRangeCheck, rangeCheck64, } from './range-check.js';
...
const Gadgets = {
     ...
     * ```
     */
    rotate(field, bits, direction = 'left') {
