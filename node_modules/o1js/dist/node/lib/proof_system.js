...
import { decodeProverKey, encodeProverKey, parseHeader, } from './proof-system/prover-keys.js';
import { setSrsCache, unsetSrsCache } from '../bindings/crypto/bindings/srs.js';
// public API
export { Proof, SelfProof, ZkProgram, ExperimentalZkProgram, verify, Empty, Undefined, Void, };
// internal API
...
async function compileProgram({ publicInputType, publicOutputType, methodIntfs, methods, gates, proofSystemTag, cache, overrideWrapDomain, }) {
