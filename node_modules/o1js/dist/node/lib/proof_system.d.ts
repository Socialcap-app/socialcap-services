import { ProvablePure, Pickles, Gate } from '../snarky.js';
...
export { Proof, SelfProof, JsonProof, ZkProgram, ExperimentalZkProgram, verify, Empty, Undefined, Void, };
...
declare function compileProgram({ publicInputType, publicOutputType, methodIntfs, methods, gates, proofSystemTag, cache, overrideWrapDomain, }: {
...
declare function ExperimentalZkProgram<StatementType extends {
    publicInput?: FlexibleProvablePure<any>;
    publicOutput?: FlexibleProvablePure<any>;
}, Types extends {
    [I in string]: Tuple<PrivateInput>;
