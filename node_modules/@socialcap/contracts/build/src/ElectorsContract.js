...
export class ElectorsContract extends SmartContract {
    ...
    updateTask(task, map, witness, updated) {
        const currentRoot = this.tasksRoot.get();
        this.tasksRoot.assertEquals(currentRoot);
        // assertOnlyDeployer();
        this.checkMerkleUpdate(task.key(), task.hash(), map, witness, updated, currentRoot);
        // set the new root
    ...
    updateNullifier(map, witness, updated) {
...
], ElectorsContract.prototype, "tasksRoot", void 0);
__decorate([
    state(Field),
    __metadata("design:type", Object)
], ElectorsContract.prototype, "nullifierRoot", void 0);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", []),
    __metadata("design:returntype", void 0)
], ElectorsContract.prototype, "assertOnlyDeployer", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [Field, Field,
        ...
        Field]),
    __metadata("design:returntype", void 0)
], ElectorsContract.prototype, "checkMerkleUpdate", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [ProvableTask,
        MerkleMapProxy,
        MerkleMapWitness,
        MerkleMapUpdate]),
    __metadata("design:returntype", void 0)
], ElectorsContract.prototype, "updateTask", null);
__decorate([
    method,
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [MerkleMapProxy,
        ...
        MerkleMapUpdate]),
    __metadata("design:returntype", void 0)
], ElectorsContract.prototype, "updateNullifier", null);
//# sourceMappingURL=ElectorsContract.js.map