...
import { testUpdateCommunity, testUpdatePerson, testUpdateMember, } from "./root-tests-helpers-01.js";
...
await testUpdateCommunity(zkApp, senderAccount, senderKey);
await testUpdatePerson(zkApp, senderAccount, senderKey);
await testUpdateMember(zkApp, senderAccount, senderKey);
//# sourceMappingURL=main-communities-tests.js.map