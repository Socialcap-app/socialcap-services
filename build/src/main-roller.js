...
import { APPROVED, REJECTED, IGNORED } from "@socialcap/contracts";
...
async function rolling() {
    ...
    for (;;) {
        ...
        // rollup all 
        let finished = await rollupClaims(claims, 
...
async function updateFinishedClaims(finished) {
    let updated = [];
...
// start 
rolling();
//# sourceMappingURL=main-roller.js.map